\relative d'' {
    ...
    bes1 ) -\! -\pp | % 34
    R1*10 | % 44
    r4 r8 gis8 ~ -\p gis2 \crescDynamic | % 45
    b1 ~ | % 46
    ...
    | % 48
    d4 -\! -\p r4 r2 | % 49
    r2 r4 r8 f'8 ~ -\mf -\< | \barNumberCheck #50
    f4 bes2 -\! -\> r4 -\! | % 51
    ...
    b4. bes8 ~ bes4 a4 | % 86
    as1 -> -\! -\f -\> | % 87
    R1*9 -\! R1*1 \fermataMarkup R1*1 | % 98
    ...
    R1*6 | % 111
    r2 a'2 ~ :32 -\fp ^ "fluttertongue" -\< | % 112
    a2. :32 b4 ~ :32 -\! -\fp -\< | % 113
    b2 :32 as2 ~ :32 -\! -\f -\> | % 114
    as2 :32 r2 -\! | % 115
    r2 r8 as4. ~ -\fp -\< | % 116
